...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "t", function() awful.spawn(mail) end,
    ...
    awful.key({ modkey, "Shift" }, "s", function() awful.spawn("flameshot gui --clipboard") end,
        { description = "take screenshot", group = "launcher" }),
    awful.key({ modkey, }, "e", function() awful.spawn(file_manager) end,
        { description = "open thunar", group = "launcher" }),
    awful.key({ modkey, }, "z", function() awful.spawn("boomer") end,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "c", function() awful.spawn("xkill") end,
